...
checkHost('进行中任务具有行内扫光动效', (() => { const css = readFileSync('src/renderer/src/styles/task-panel.css', 'utf8'); return css.includes('@keyframes task-active-sweep') && css.includes('animation: task-active-sweep 1.9s'); })())
