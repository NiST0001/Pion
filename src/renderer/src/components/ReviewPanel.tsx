...
import { FileDiff, FilePenLine, FilePlus2, RotateCcw, X } from 'lucide-react'
    ...
    <aside className="review-panel" style={{ width, flexBasis: width }}>
      ...
      <header className="review-panel-head">
        ...
        <div className="review-panel-actions">
          ...
          <button type="button" className="icon-button review-close-button" title="关闭文件与审查栏" onClick={onClose}>
            <X size={15} />
          </button>
        </div>
      </header>
